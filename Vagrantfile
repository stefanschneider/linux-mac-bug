Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    wget http://kernel.ubuntu.com/~kernel-ppa/mainline/v4.11-rc5/linux-headers-4.11.0-041100rc5_4.11.0-041100rc5.201704022131_all.deb
    wget http://kernel.ubuntu.com/~kernel-ppa/mainline/v4.11-rc5/linux-headers-4.11.0-041100rc5-generic_4.11.0-041100rc5.201704022131_amd64.deb
    wget http://kernel.ubuntu.com/~kernel-ppa/mainline/v4.11-rc5/linux-image-4.11.0-041100rc5-generic_4.11.0-041100rc5.201704022131_amd64.deb
    sudo dpkg -i *.deb
