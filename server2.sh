...
sudo ip link set dev enp0s8 address 08:00:22:33:`openssl rand -hex 1`:`openssl rand -hex 1`
...
sudo ip neigh replace 192.168.50.4 nud permanent dev enp0s8 lladdr 08:00:27:fb:93:99
